                          ...
                          children: <Widget>[
                            ...
                            Align(
                              ...
                              child: GestureDetector(
                                onTap: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) {return ForgotPasswordView();})),
                                child: Text("Forgot your password?", textAlign: TextAlign.left, style: TextStyle(color: Colors.lightBlueAccent),),
                              ),
                            ),
                            new Padding(
                              padding: const EdgeInsets.only(top: 20.0),
